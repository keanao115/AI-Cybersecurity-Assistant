...
describe('Live Telemetry Data Collection Suite', () => {
  ...
  describe('4. NetFlow v5 Binary Frame Decoder', () => {
    test('Should decode 24-byte header and 48-byte NetFlow v5 record', () => {
      ...
      buf.writeUInt8(10, 24); buf.writeUInt8(0, 25); buf.writeUInt8(0, 26); buf.writeUInt8(5, 27);  // Src 10.0.0.5
      buf.writeUInt8(8, 28); buf.writeUInt8(8, 29); buf.writeUInt8(8, 30); buf.writeUInt8(8, 31);  // Dst 8.8.8.8
