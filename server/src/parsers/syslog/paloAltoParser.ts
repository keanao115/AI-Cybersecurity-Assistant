...
export class PaloAltoPanOsParser implements SyslogVendorParser {
  public name = 'Palo Alto PAN-OS CSV Syslog Parser';
  public vendor = 'Palo Alto Networks';
  public product = 'PAN-OS';
  ...
  public parse(header: ParsedSyslogRfc, raw: string): VendorParseResult {
    ...
    if (fields.length >= 10) {
      ...
      if (logType === 'THREAT') result.severity = 'High';
