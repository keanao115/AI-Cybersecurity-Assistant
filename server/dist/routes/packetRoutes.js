...
packetRouter.post('/upload', upload.single('pcapFile'), (req, res) => {
    if (!req.file) {
...
packetRouter.get('/sample', (req, res) => {
...
packetRouter.post('/analyze-pcap', (req, res) => {
