...
export const SIGMA_RULES = [
    {
        ...
        match: (e) => (e.eventId === '4625' || e.commandLine?.includes('4625')) &&
    ...
    },
    {
        ...
        match: (e) => (e.eventId === '4688' || e.commandLine?.includes('4688')) &&
    ...
    },
    {
        ...
        match: (e) => e.sourceType?.toLowerCase().includes('linux') &&
    ...
    },
    {
        ...
        match: (e) => (e.sourceType?.toLowerCase().includes('linux') || e.raw?.includes('sshd')) &&
    ...
    },
    {
        ...
        match: (e) => e.sourceType?.includes('Suricata') &&
            (e.alert?.severity === 1 ||
    ...
    },
    {
        ...
        match: (e) => e.sourceType?.includes('Nmap') &&
    ...
    },
    {
        ...
        match: (e) => (e.commandLine?.toLowerCase().includes('wmic') ||
    ...
    },
    {
        ...
        match: (e) => e.commandLine?.toLowerCase().includes('lsass') ||
...
export function evaluateSigmaRules(event) {
    const matches = [];
...
export function scanWithSigmaRules(events) {
    const detections = [];
    ...
    for (const event of events) {
        ...
        if (matches.length > 0) {
            ...
            for (const m of matches)
                summary[m.level] = (summary[m.level] || 0) + 1;
        }
    }
    return {
