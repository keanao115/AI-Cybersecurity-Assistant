...
export default function Sidebar({ activeTab, setActiveTab }) {
  ...
  return (
    <aside className="w-64 border-r border-cyan-500/15 bg-slate-950/60 backdrop-blur-xl flex flex-col justify-between py-4 shrink-0">
      <div className="space-y-1 px-3">
        <div className="px-3 py-2 text-[11px] font-mono font-semibold text-slate-400 uppercase tracking-widest">
          SOC NAVIGATION
        </div>
        {navItems.map((item) => {
